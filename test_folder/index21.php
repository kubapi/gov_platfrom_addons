...
<html lang="pl">
  <head>
    ...
    <title><?php gettext('GovTech - <?php gettext('Zaloguj się')?>')?></title>
 ...
 &nbsp; <a href="#" class="changeFontSize changeLink"><span data-feather="zoom-in"></span> <?php gettext('Powiększ tekst')?></a>
    ...
    <div class="row header-logo">
      <div class="col-md-8 offset-md-2 my-5 text-left">
        <div class="h2"><strong><?php gettext('<?php gettext('Platforma GovTech')?>')?></strong></div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url()?>"><?php gettext('<?php gettext('Platforma GovTech')?>')?></a></li>
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2 my-2 text-left">
        <div class="h3 mb-4"><strong><?php gettext('<?php gettext('Zaloguj się')?> na Plaformę GovTech')?></strong></div>
...
?>
      ...
      <input type="email" id="inputEmail" class="form-control" placeholder="<?php gettext('Adres email')?>" name="user_email" required autofocus>
      <?php echo form_error('user_password'); ?>
      <label for="inputPassword" class="mt-2"><?php gettext('Hasło')?></label>
      <input type="password" id="inputPassword" class="form-control" placeholder="<?php gettext('Hasło')?>" name="user_password" required>
<?php if($_counter>7 || $_login_failure_count>7){ ?>
      <div class="mb-3">
